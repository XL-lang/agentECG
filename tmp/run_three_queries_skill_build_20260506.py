...
SAMPLE_IDS = ["65087", "107808", "113310"]


def main() -> None:
    print(f"Starting skill_build run for sample_ids={SAMPLE_IDS}")
    special_queries = [
    ...
    count = run_multithreaded_processing(
        ...
        max_workers=1,
        output_file="tmp/run_three_query_skill_build_results_20260506.json",
        save_agent_mem=False,
        agent_mem_file="tmp/run_three_query_skill_build_agent_mem_20260506.json",
