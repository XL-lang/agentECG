...
def main() -> None:
    print(f"Starting background run for sample_ids={SAMPLE_IDS}")
    special_queries = [
    ...
    count = run_multithreaded_processing(
        ...
        max_workers=1,
        output_file="tmp/run_four_query_results_20260505.json",
        save_agent_mem=False,
        agent_mem_file="tmp/run_four_query_agent_mem_20260505.json",
        run_mode="eval",
    )
